...
{	
	...
	@When("Alex search particular product like {string}")
	public void alex_search_particular_product_like(String string) 
	{
	...
	{
		Assert.assertNull(driver.findElement(By.xpath("/html/body/b/div/div/div[1]/div/div[2]/div[3]/div/form[2]/input")));
